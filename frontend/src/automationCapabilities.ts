export const AUTOMATION_CAPABILITIES = {
  available: [
    ...
    'research-revision-guarded MCP scenario creation, turn editing, aggregate voting with best-effort registered-device attribution, annotation lifecycle, and shared labels',
