...
async function proveStdioContract() {
  ...
  if (contracts?.implementationStatus?.remoteProviderAdapters !== 'native-disclosure-openai-anthropic-gemini-xai-stream-tool-proposal-review-ui-no-live-proof') throw new Error('aggregate provider status is inaccurate')
