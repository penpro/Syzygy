export const AUTOMATION_CAPABILITIES = {
  available: [
    ...
    'read-only MCP integrity inspection for scenarios, votes, signed research-event device attestations, annotations, labels, heuristics, and immutable version history',
