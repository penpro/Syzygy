    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            if let Err(error) = lan_dev_coordinator::start_saved(app.handle()) {
                ...
                log::warn!("Private LAN developer coordinator unavailable: {error}");
            }
...
{details}"
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            drive_projects::google_drive_project_title_repair_inspect,
            drive_projects::google_drive_project_title_repair,
            ...
            lan_runtime::lan_pairing_key_create,
            ...
            collaboration_identity::collaboration_identity_sign_relay_access,
            collaboration_identity::collaboration_identity_sign_relay_admin,
            collaboration_identity::collaboration_identity_sign_relay_admin_decision,
            collaboration_identity::collaboration_identity_sign_relay_admin_approval,
            collaboration_identity::collaboration_identity_sign_research_event,
