...
| `frontend/src-tauri/src/collaboration_identity.rs` | Penumbra original | OS-vault Ed25519 installation key plus separately domain-scoped canonical live-presence and project-registration signing surfaces with zeroized private material |
