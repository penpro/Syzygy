    ...
    <svg width={size} height={size} viewBox="0 0 256 256" aria-hidden="true" style={{ flex: '0 0 auto' }}>
      <defs>
        ...
        <radialGradient id="cm-bloom" cx="50%" cy="50%" r="50%">
          <stop offset="62%" stopColor="var(--accent-2)" stopOpacity="0" />
          <stop offset="82%" stopColor="var(--accent)" stopOpacity="0.5" />
      ...
      {showOrbit && (
        <g transform="rotate(-22 128 128)">
          ...
          <circle cx="236" cy="128" r="16" fill="var(--magenta)" opacity="0.5" filter="url(#cm-halo)" />
          <circle cx="236" cy="128" r="7" fill="url(#cm-planet)" />
          <circle cx="233" cy="125" r="2" fill="var(--text)" opacity="0.9" />
        </g>
      )}
      ...
      <circle cx="128" cy="128" r="70" fill="var(--bg)" />
      <circle cx="128" cy="128" r="71" fill="none" stroke="url(#cm-ring)" strokeWidth="6" />
      <circle cx="128" cy="128" r="71" fill="none" stroke="var(--text)" strokeWidth="1.4" opacity="0.9" />
    </svg>
  )
}
